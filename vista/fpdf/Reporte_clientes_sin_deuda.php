...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE CLIENTES SIN DEUDAS"), 0, 1, 'C', 0);
      $this->Ln(7);
...
$pdf->Output('Reporte_clientes_al_dia.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
